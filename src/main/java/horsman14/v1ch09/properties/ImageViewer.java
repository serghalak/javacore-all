package horsman14.v1ch09.properties;
...
/**
 * An image viewer that restores position and size from a properties file and
 * updates the properties upon exit.
 */
class ImageViewerFrame extends JFrame {
    ...
    public ImageViewerFrame() {
        ...
        if (propertiesFile.exists()) try (var in = new FileInputStream(propertiesFile)) {
            settings.load(in);
        }
