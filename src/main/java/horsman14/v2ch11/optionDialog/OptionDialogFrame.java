...
public class OptionDialogFrame extends JFrame {
    ...
    private Icon messageIcon = new ImageIcon("images/blue-ball.gif");
     ...
     * @return a string, icon, component, or object array, depending on the Message panel
     *         selection
     */
    ...
    public Object[] getOptions() {
        ...
        if (s.equals("String[]"))
            ...
            return new Icon[] { new ImageIcon("images/yellow-ball.gif"),
                    new ImageIcon("images/blue-ball.gif"),
                    new ImageIcon("images/red-ball.gif") };
        else if (s.equals("Object[]"))
            return new Object[] { messageString, messageIcon, messageComponent, messageObject };
        else
            return null;
