...
class CollationFrame extends JFrame {
    ...
    JTextArea sortedWords = new JTextArea(20, 20);
    JButton addButton = new JButton("Add");
    EnumCombo<Integer> strengthCombo = new EnumCombo<>(Collator.class, "Primary",
            "Secondary", "Tertiary", "Identical");
    EnumCombo<Integer> decompositionCombo = new EnumCombo<>(Collator.class,
