...
import horsman14.v2ch07.util.EnumCombo;
...
class DateTimeFormatterFrame extends JFrame {
    ...
    JButton dateParseButton = new JButton("Parse");
    JButton timeParseButton = new JButton("Parse");
    JButton dateTimeParseButton = new JButton("Parse");
    JTextField dateText = new JTextField(30);
    JTextField timeText = new JTextField(30);
    JTextField dateTimeText = new JTextField(30);
    EnumCombo<FormatStyle> dateStyleCombo = new EnumCombo<>(FormatStyle.class, "Short",
            "Medium", "Long", "Full");
    EnumCombo<FormatStyle> timeStyleCombo = new EnumCombo<>(FormatStyle.class, "Short",
            "Medium");
    EnumCombo<FormatStyle> dateTimeStyleCombo = new EnumCombo<>(FormatStyle.class,
    ...
    DateTimeFormatterFrame() {
        ...
        addAction(dateTimeParseButton, () -> {
            currentDateTime = ZonedDateTime.parse(dateTimeText.getText().strip(),
     ...
     */
    void addAction(JButton button, Runnable action) {
