...
class StaticInnerClassDemo {
    void main() {
        ...
        IO.println("from = " + r.getFrom());
        IO.println("to = " + r.getTo());
    }
...
class ArrayAlg {
    ...
    /**
     * A "run" is a sequence of repeating adjacent elements. For example, in the
     * array 1 2 3 3 3 4 4, the runs are (trivially) 1 and 2, and 3 3 3 3 and 4
     * 4. Returns the range of the longest run.
     *
