package horsman14.v1ch07.logging;
...
/**
 * A modification of the image viewer program that logs various events. Run as java
 * -Djava.util.logging.config.file=logging.properties logging.LoggingImageViewer
 */
    ...
    private class FileOpenListener implements ActionListener {
        public void actionPerformed(ActionEvent event) {
            ...
            if (r == JFileChooser.APPROVE_OPTION) {
                ...
                logger.log(DEBUG, "File open dialog canceled.");
